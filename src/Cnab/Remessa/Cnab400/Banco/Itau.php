...
class Itau extends AbstractRemessa implements RemessaContract
{
    ...
    protected function header()
    {
        ...
        $this->add(38, 38, $this->getContaDv() || (string) $this->getContaDv() === '0' ? $this->getContaDv() : CalculoDV::itauContaCorrente($this->getAgencia(), $this->getConta()));
        $this->add(39, 46, '');
    ...
    public function addBoleto(BoletoContract $boleto)
    {
        ...
        $this->add(29, 29, $this->getContaDv() || (string) $this->getContaDv() === '0' ? $this->getContaDv() : CalculoDV::itauContaCorrente($this->getAgencia(), $this->getConta()));
        $this->add(30, 33, '');
        $this->add(34, 37, '0000');
